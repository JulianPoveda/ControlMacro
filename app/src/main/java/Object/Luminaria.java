...
public class Luminaria {
    ...
    public void setCodigoLuminaria(String codigoLuminaria) {
    ...
    public String getEstadoLuminaria() {
        return estadoLuminaria;
    }

    public void setEstadoLuminaria(String estadoLuminaria) {
